...
# Usage: ./deploy-acr.sh <resource-group-name> [template-file] [parameters-file]
...
TEMPLATE_FILE=${2:-"acr-template.json"}
PARAMETERS_FILE=${3:-"acr-parameters.json"}
...
DEPLOYMENT_NAME="acr-deployment-$(date +%Y%m%d-%H%M%S)"
